      ...
      <div className="container px-6 mx-auto space-y-6 divide-y divide-coolGray-400 md:space-y-12 divide-opacity-50">
        <div className="grid justify-center pt-6 lg:justify-between">
          <div className="flex flex-col self-center text-sm text-center md:block lg:col-start-1 md:space-x-6">
            <Link href="#distance"><span>🏃‍♂️ Distance</span></Link>
            <Link href="#runs"><span>💯 Runs</span></Link>
            <Link href="#time"><span>⏱ Time</span></Link>
            <Link href="#elevation"><span>🏔 Elevation</span></Link>
          </div>
          <div className="flex justify-center pt-4 space-x-4 lg:pt-0 lg:col-end-13">
            <Link href="https://www.strava.com" rel="noopener noreferrer" target="_blank" className="flex items-center justify-center w-40 h-10 rounded-full dark:text-coolGray-900">
              <img src="/images/api_logo_pwrdBy_strava_horiz_light.png" alt="Powered by Strava" />
            </Link>
            <Link href="https://www.curtiscode.dev" rel="noopener noreferrer" target="_blank" className="flex items-center justify-center w-10 h-10 rounded-full dark:bg-teal-400 dark:text-coolGray-900">
            ...
            <Link href="https://github.com/curtiscde" rel="noopener noreferrer" title="GitHub" target="_blank" className="flex items-center justify-center w-10 h-10 rounded-full dark:bg-teal-400 dark:text-coolGray-900">
